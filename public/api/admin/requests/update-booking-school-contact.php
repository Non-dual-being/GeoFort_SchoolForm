...
$container['controllers'][DashboardBookingSchoolContactUpdateAction::class]->send(
    (string)($_SERVER['REQUEST_METHOD']??''),(string)($_SERVER['CONTENT_TYPE']??''),
    isset($_SERVER['HTTP_X_CSRF_TOKEN'])?(string)$_SERVER['HTTP_X_CSRF_TOKEN']:null,
    file_get_contents('php://input')?:'',(string)($_SERVER['HTTP_USER_AGENT']??''),
);
