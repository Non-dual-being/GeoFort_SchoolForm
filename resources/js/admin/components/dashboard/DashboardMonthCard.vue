...
<template>
  <article class="admin-card admin-overview-card">
    ...
    <div class="admin-overview-statistics">
      <dl>
      ...
      <RouterLink class="admin-button admin-button--secondary admin-overview-card__cta" :to="{ name: 'calendar', query: { month: monthKey } }">
        <span>Bekijk in agenda</span><span aria-hidden="true">→</span>
      </RouterLink>
    </div>
  </article>
</template>
