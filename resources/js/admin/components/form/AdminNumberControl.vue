...
const props=withDefaults(defineProps<{modelValue:number|null;label:string;description?:string;min?:number;max?:number;step?:number;unitLabel?:string;error?:string|null;disabled?:boolean;controls?:boolean}>(),{description:undefined,min:undefined,max:undefined,step:1,unitLabel:undefined,error:null,disabled:false,controls:true});
