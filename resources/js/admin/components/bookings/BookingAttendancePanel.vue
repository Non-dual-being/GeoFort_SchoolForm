    ...
    <details class="admin-attendance-help">
      ...
      >
        ...
        >
          ...
          <span role="cell">
            De boeking wordt na iedere wijziging opnieuw volledig gecontroleerd.
          </span>
        </div>
