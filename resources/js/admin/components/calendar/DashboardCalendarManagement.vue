...
import { computed, inject, onBeforeUnmount, onDeactivated, reactive, ref, watch } from "vue";
import { ChevronLeft, ChevronRight } from "lucide-vue-next";
import AdminButton from "../form/AdminButton.vue";
import AdminInlineNotice from "../form/AdminInlineNotice.vue";
import DashboardCalendarDayCell from "./DashboardCalendarDayCell.vue";
import DashboardCalendarDayDetail from "./DashboardCalendarDayDetail.vue";
import DashboardCalendarDateManagementDialog from "./DashboardCalendarDateManagementDialog.vue";
import DashboardCalendarViewSelector from "./DashboardCalendarViewSelector.vue";
import DashboardCalendarActionCard from "./DashboardCalendarActionCard.vue";
import AdminCollapsibleHelp from "../help/AdminCollapsibleHelp.vue";
...
import { invalidateDashboardCalendarOverviewCache } from "../../services/dashboardCalendarOverviewApi";
...
async function submitManagement(): Promise<void> {
  ...
  try {
    ...
    invalidateDashboardCalendarOverviewCache(preview.value.startDate, preview.value.endDate);
    await load();
...
function abortRequests(): void { controller?.abort(); previewController?.abort(); }
onDeactivated(abortRequests);
onBeforeUnmount(abortRequests);
</script>

<template>
  <section class="admin-calendar-management" aria-label="Agendabeheer">
