...
const props=withDefaults(defineProps<{step:number;totalSteps:number;nextDisabled?:boolean;submitting?:boolean}>(),{nextDisabled:false,submitting:false});
...
<template>
  <div class="admin-wizard-actions">
    ...
    <AdminButton v-else class="admin-wizard-actions__primary" type="button" :loading="submitting" :disabled="nextDisabled||submitting" @click="emit('submit')">Configuratie opslaan</AdminButton>
  </div>
</template>
