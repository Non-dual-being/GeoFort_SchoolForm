...
$pdo->exec("INSERT INTO booking_day_settings VALUES ('2026-08-03',1,100)");
$rows = [
...
$service = new DashboardCalendarOverviewService(new DashboardCalendarOverviewSqlRepository($pdo), new DisabledDatesSqlService($pdo), new BookingDaySettingsSqlRepository($pdo));
...
$assert($day['hasBookingsOnBlockedDate'] === true, 'Blocked planningboolean ontbreekt.');
$assert($day['capacity'] === ['totalDaily'=>100,'programs'=>['dag'=>100,'ochtend'=>80]], 'Kalenderbezetting verliest dagoverride of programmagrens.');
