...
$preview = CalendarDateManagementPreviewRequest::fromJson('{"startDate":"2026-09-24","endDate":"2026-09-30","action":"block_period"}');
...
foreach (['weekendDates', 'existingManualDates', 'otherBlockedDates', 'activeBookingDates', "hash('sha256'"] as $needle) {
...
$assert(str_contains($repository, 'DELETE FROM disabled_dates WHERE datum = :date AND type = :type'), 'Vrijgave is niet beperkt tot manual-records.');
