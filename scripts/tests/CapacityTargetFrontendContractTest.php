...
$assert(str_contains($settingsPanel, 'admin-capacity-target-info') && str_contains($settingsPanel, 'maximaal 160 leerlingen en 2 boekingsplekken') && str_contains($settingsPanel, 'Oudere resultaten blijven gekoppeld') && str_contains($settingsPanel, 'Bij 0 gewenste boekingen'), 'Het begeleidende informatieveld is onvolledig.');
...
$assert(str_contains($scenario, 'evaluationIncluded') && str_contains($scenario, 'day.available') && str_contains($scenario, 'bookingsTarget > 0'), 'Scenario gebruikt niet dezelfde beschikbare-dag- en nuldelingsformules.');
