...
$assert(substr_count($view, 'monthly-window') >= 4 && str_contains($chartComponent, 'horizontaal scrollbaar maandvenster') && str_contains($chartComponent, 'visibleMonths'), 'Herbruikbaar horizontaal maandvenster ontbreekt.');
$assert(str_contains($tableComponent, 'admin-analytics-table-wrap--monthly') && str_contains($tableComponent, 'scrollbaar maandvenster') && str_contains($css, '--analytics-month-rows: 6') && str_contains($css, '--analytics-month-rows: 4') && str_contains($css, '--analytics-month-rows: 3'), 'Verticaal maandvenster of toegankelijke naam ontbreekt.');
