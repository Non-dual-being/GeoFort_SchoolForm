...
final class DashboardBootstrapService
{
    ...
    public function build(): DashboardBootstrapData
    {
        return new DashboardBootstrapData(
            ...
            rosterSessionCsrfToken: $this->csrfTokenService->getOrCreate('manage-roster-session'),
            rosterGenerationCsrfToken: $this->csrfTokenService->getOrCreate('generate-roster-plan'),
            ...
            legacyPriceAcceptanceCsrfToken: $this->csrfTokenService->getOrCreate('accept-legacy-booking-price'),
            capacityTargetCsrfToken: $this->csrfTokenService->getOrCreate('update-capacity-target'),
