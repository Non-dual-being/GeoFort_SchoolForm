...
final readonly class DashboardRosterGenerationApplyAction
{
    ...
    public function send(string $method, string $contentType, ?string $token, string $body, string $userAgent): void
    {
        ...
        try {
            ...
            error_log('[DashboardRosterGenerationApplyAction] apply failed: ' . $exception::class);
            $this->response->serverError('Roostervoorstel kon niet worden toegepast.', 500, false)->send();
        }
    }
