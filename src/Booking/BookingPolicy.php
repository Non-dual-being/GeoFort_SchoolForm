...
{
    public const PROGRAM_REGULAR = 'Regulier';
    ...
    public const MAX_STUDENTS_PROGRAM_ARRAY = [
        self::PROGRAM_REGULAR => self::MAX_STUDENTS_PER_DAY_REGULAR_PROGRAM,
        self::PROGRAM_MORNING => self::MAX_STUDENTS_PER_DAY_MORNING_PROGRAM,
    ];
